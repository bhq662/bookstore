...
public class BookstoreApplication {
	...
	public CommandLineRunner demo(BookRepository repository) {
		return (args) -> {
			...
			Book b2 = repository.save(new Book("Foe", "Iain Reid", 2019, 9781471177989L, 14.99f));
			System.out
					.println("Book id= " + b2.getIsbn() + ", title= " + b2.getTitle() + ", author= " + b2.getAuthor());
			Book b3 = repository.save(new Book("1Q84", "Haruki Murakami", 2012, 9780099578079L, 22.99f));
			System.out
